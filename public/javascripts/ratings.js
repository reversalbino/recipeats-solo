...
if(tempUserId != null) {
  document.getElementById('temp-container').innerHTML = `
    <div class="container">
      <div class="feedback">
        <div class="rating">
          <input class='star' type="radio" name="rating" value = '5' userId = ${tempUserId} id="rating-5">
          <label for="rating-5"></label>
          <input class='star' type="radio" name="rating" value = '4' userId = ${tempUserId} id="rating-4">
          <label for="rating-4"></label>
          <input class='star' type="radio" name="rating" value = '3' userId = ${tempUserId} id="rating-3">
          <label for="rating-3"></label>
          <input class='star' type="radio" name="rating" value = '2' userId = ${tempUserId} id="rating-2">
          <label for="rating-2"></label>
          <input class='star' type="radio" name="rating" value = '1' userId = ${tempUserId} id="rating-1">
      ...
      star.addEventListener('click', async(e) => {
          ...
          if(data.message === 'success'){
              ...
              for (let i = 0; i < Math.floor(nearestHalf); i++) {
                  ratingContainer.innerHTML += `<span class="fa fa-star checked"></span>`;
              }
              // adding half stars
              if (!(nearestHalf == 1 || nearestHalf == 2 ||nearestHalf == 3 ||nearestHalf == 4 || nearestHalf == 5)){
                  ratingContainer.innerHTML += `<span class="fa fa-star-half-o checked"></span>`
              }
          }
      })
  }
